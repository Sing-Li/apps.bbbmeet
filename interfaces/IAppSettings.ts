...
import {ISetting, ISettingSelectValue} from '@rocket.chat/apps-engine/definition/settings'
...
export interface IAppSetting {
    ...
    valuesSourceFunc?: (accessors: IAppAccessors) => Promise<Array<ISettingSelectValue>>
}
